        ...
        sshThread = Thread {
            try {
                ...
                val session = jsch.getSession(
                    "YOUR_SSH_USER",   // Replace with SSH username
                    "YOUR_SSH_HOST",   // Replace with server host
                    YOUR_SSH_PORT      // Replace with port number
                )
                
                session.setPassword("YOUR_SSH_PASS") // Replace with password
                ...
                Log.d("SSHVPN", "SOCKS5 proxy started")
